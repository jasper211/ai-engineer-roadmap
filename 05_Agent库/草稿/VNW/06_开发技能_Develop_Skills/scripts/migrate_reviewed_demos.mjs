...
const ibrdDelivery = {
  '01': ['支撑交付物', '资格条件核验、资料缺项识别', '自动预审并生成启动清单', '资格条件有依据、缺项可定位'],
  '02': ['支撑交付物', '责任识别、协作规则设计', 'AI建议沟通机制；人确认责任关系', '责任人、频率和升级路径明确'],
  '03': ['支撑交付物（测试拆分）', '多源调查、证据归集、异常提示', '执行标准查验并生成证据包', '证据完整、异常可追溯'],
  '04': ['控制交付物', '牌照核验、权威确认', 'AI检索比对；人完成保司确认', '牌照状态与权威确认一致'],
  '05': ['支撑交付物（测试拆分）', '股权穿透、关联方识别', '执行查册、穿透和风险标记', '穿透路径完整、异常有证据'],
  '06': ['控制交付物（测试拆分）', '规则评分、合规判断、升级处置', 'AI建议评级；人批准高风险结论', '评级规则明确、升级留痕'],
  '07': ['核心价值交付物（测试拆分）', '路径选择、商业与合规权衡', 'AI形成建议；负责人作出决议', '准入依据完整、决议可追溯'],
  '08': ['支撑交付物（测试拆分）', '到期监控、事件触发、差异复核', '持续监控并发起更新', '触发及时、变化有记录'],
}
