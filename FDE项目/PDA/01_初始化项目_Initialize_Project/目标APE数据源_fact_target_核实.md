...
**排除 NGP/TA 的原因（2026-09-20 Jasper确认）**：当时的假设成立——NGP 是尚无实际业务量的规划线路，TA(MGA业务/天誉)单独核算、不计入这两个"全业务"口径的汇总。不再是待确认项。
...
- [x] Jasper 确认"全业务目标"/"永明业务目标"口径里排除 NGP、TA 两个 segment 的原因（2026-09-20，假设成立）
