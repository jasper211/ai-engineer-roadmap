...
def build_s2():
    ...
    print("✅ S2_业务端视角 全部20个板块(A/B/C-H/I/J/K/O/S/T)已生成")
    print("   A/B/C/I/J/K/O/S/T 已用真实『业绩分析报表_0724.xlsx』核验，D-H/L-T月度趋势为同规则参数化推算")
    print("   S节行排序有已知限制，见 S2_业务端视角_反推标准_v0.1.md")
    print(f"输出目录: {out_dir}")
